...
//	private static final String PREFS_NAME = "ExTrace.cfg";
	...
	IDataAdapter<List<CustomerInfo>> adapter;//##数据适配器，泛型接口，里面有三个方法
...
//		}
	...
	@Override
	public void onDataReceive(String class_data, String json_data) {//##接受数据
		if(json_data.equals("Deleted")){
			...
			{
				List<CustomerInfo> cstm = JsonUtils.fromJson(json_data, new TypeToken<List<CustomerInfo>>(){});//##转换成json数据
